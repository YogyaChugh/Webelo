...
> **bool returnValue** is legacy only and is implemented as a <u>*special*</u> getter/setter function for cancelable value. It returns whether default action for this event has been cancelled or not. Basically returning negation of `canceled flag`
